# Capistrano3 Notifier [![Build Status](https://secure.travis-ci.org/applicaster/capistrano3-notifier.png)](https://secure.travis-ci.org/applicaster/capistrano3-notifier)
